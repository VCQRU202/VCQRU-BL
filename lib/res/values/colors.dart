...
class AppColors {
  ...
  static const Color yellow_app_dark = Color(0xFFF84464);
  static const Color yellow_app = Color(0xFFABADB5);
  static const Color bottom_tab_select_color = Color(0xFFDFE0E3);
  static const Color text_app = Color(0xFF613010);
  static const Color quiz_screen_color = Color(0xFF2E3147);
  static const Color whiteShade1 = Color(0xFFF6F6F6);
  static const Color whiteShade2 = Color(0xFFF8F9FD);
  static const Color dashboard_color = Color(0xFFF30606);
  static const Color button_color = Color(0xFF16083D);
  static const Color pending_color = Color(0xFFFFC107);
  static const Color failed_color = Color(0xFFFF0000);
  static const Color diveder_color = Color(0xFFF7F8FC);
  ...
  static const Color greyShade6 = Color(0xFFF8F9FA);
...
//  static const Color violetShade2 = Color(0xFF9121F9);
  ...
  // app default color
  static const App_Default_Color=Color(0xff336cff);
  static const App_Dashboard_blue_Color=Color(0xff336CFFFF);

  // static const App_history_Color=Color(0xffFFAF00FF);

  static const App_History_Color=Color(0xffeba73f);
  static const App_Claim_Color=Color(0xff5acdb3);
  static const App_Claim_history_Color=Color(0xffe56735);

  static const App_wallet_Color=Color(0xff298aec);

  static const App_warranty_Color=Color(0xff86cb50);

  static const App_Authenticity_Color=Color(0xffeba940);

  static const App_Loyalty_Color=Color(0xff86cb50);

  //app intro
  static const App_Intro_Color=Color(0xffFFE6E6);
  static const App_Intro_Color2=Color(0xFFCDF0EA);
  static const App_Intro_Color3=Color(0xFFFFDCA9);
