...
class StringConst {
  ...
  static const String DESIGN_DEVELOP_BY = "Design and development by VCQRU.";
  ...
  static const String BACK_LOGIN = "BACK TO LOGIN";
  static const String CONTINUE = "CONTINUE";
  static const String COMPLETE_KYC = "COMPLETE YOUR KYC";
  static const String SKIP = "SKIP FOR LATER";
  static const String SUBMIT1 = "   SUBMIT   ";
  static const String SEND = "SEND";
  static const String WHO_ARE_YOU = "WHO ARE YOU ?";
  static const String STUDENT = "Student";
  static const String ALLREADY_REGISTER = "Already Registered ?";
  static const String ORGANIZATION = "Organization";
  static const String REG_IN_TION = "PARTNERSHIP WITH US";
  static const String LOG_IN_4 = "Log In";
  static const String LOG_IN_OTP = "SIGN UP";
  static const String SCAN_FINGER = "Scan Fingerprint";
  static const String REDEEM_HERE = "REDEEM HERE";
  static const String USE_YOUR_COIN = "Use your coins";
  static const String CLICK_HERE_QUIZE = "Play Quiz";
  ...
  //----------------Lable-----------------------
  static const String MOBILE_NO_LABLE ="Mobile Number *";
  static const String PASSWORD_LABLE ="Enter Your Password *";
  static const dashboard_loyalty='Loyalty';
  static const dashboard_authenticity='Authenticity';
  ...
  static const dashboard_claim_history="Claim History";
  static const dashboard_fake_product='Fake Product';
