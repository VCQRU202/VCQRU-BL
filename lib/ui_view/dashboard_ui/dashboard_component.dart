...
import '../claim_all/claim_ui_main_list.dart';
                          ...
                          child: GestureDetector(
                            ...
                            if(item.id.toString().endsWith("gift")){
                             ...
                             // Navigator.push(context, MaterialPageRoute(builder: (context)=>ClaimScreen()));
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>ClaimStartMain()));
                              ...
                              children: [
                                SvgPicture.network(
                                  ...
                                  placeholderBuilder: (context) {
                                    ...
                                    return CircularProgressIndicator(strokeWidth: 1,); // Show loading spinner
                                  },
                                  fit: BoxFit.contain,
